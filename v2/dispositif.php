                        ...
                        <table class="table table-bordered">
                                ...
                                <td><?php
                                    if ($nbPrix != 0)
                                    {
                                             ...
                                             $i++)
                                        {
                                            ...
                                            {
                                                ?> vu sur <a href="http://<?php echo $tableauPrixSiteV[$i][1]; ?>"
                            ...
                            if ($urlSiteFab != "") {
                                ...
                                <tr class="dispositif active">
                                    ...
                                    <td><a href="http://<?php echo $urlSiteFab; ?>" target="_blank"> <?php echo $nomSiteFab; ?></a>
                                    </td>
                                </tr>
                                <?php
                            } else {
                                ...
                                <tr class="dispositif info">
                                    ...
                                    <td>
                                        ...
                                        while ($LgnSim = mysqli_fetch_array($TabSim)) {
                                            ?>
                                            <a href="dispositif.php?idDis=<?php echo $LgnSim["id_dispositif"]; ?>"><?php echo $LgnSim["nom_dis"]; ?></a>
                                            <br/>
                                            <?php
                                        }
                                        ?>
