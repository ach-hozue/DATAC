...
<div class="taillePetite">
    ...
    <!-- <form action="recherche.php" method="POST">
        <div class="form-group">      -->                                                                                                           <!--récupère la recherche de l'utilisateur-->
        <!--    <input class="btn btn-toolbar recherchePetit" autocomplete="on" type="text" placeholder="Chercher un dispositif..." name="recherche" value="<?php //echo (isset($_POST["recherche"]))?$_POST["recherche"]:""; ?>" />
        </div>
    </form>
</div> -->